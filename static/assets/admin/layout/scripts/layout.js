...
var Layout = function () {
    ...
    var handleSidebarAndContentHeight = function () {
        ...
        if (body.hasClass("page-footer-fixed") === true && body.hasClass("page-sidebar-fixed") === false) {
            ...
            if (content.height() < available_height) {
                content.attr('style', 'height:' + available_height + 'px;overflow: auto;');
            }
        } else {
            ...
            content.attr('style', 'height:' + height + 'px;overflow: auto;');
        }
    };
    ...
    var handleGoTop = function () {
        ...
        if (navigator.userAgent.match(/iPhone|iPad|iPod/i)) {  // ios supported
            // modified by houyongbo 20170717   window->".page-content"
            $(".page-content").bind("touchend touchcancel touchleave", function(e){
        ...
        $('.scroll-to-top').click(function(e) {
            ...
            // modified by houyongbo 20170717   'html, body'->".page-content"
            $(".page-content").animate({scrollTop: 0}, duration);
            return false;
        });
    };
