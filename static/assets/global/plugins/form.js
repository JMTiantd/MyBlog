		...
		$instance.find("input,div,textarea,select").each(function(i) {
			...
			if (n) {
				...
				try {
					...
					var trueType = $(this).attr("trueType");
					if (trueType == "textinput" || trueType == "autoComplete"
							|| trueType == "date" || trueType == "keypad"
							|| trueType == "stepper" || trueType == "password"
							|| trueType == "hidden") {
						$(this).val(fieldValue)
					} else {
						if (trueType == "color") {
